...
.on('change', function (blenderFilePath) {
  ...
  var actions2json = './node_modules/blender-actions-to-json/bin/actions2json.js'

  var exportCommand = `blender model.blend --background --python \`./node_modules/blender-iks-to-fks/bin/ik2fk.js\` --python \`${actions2json}\` --python blender-to-dae.py -- ${actionPath} ${colladaPath}`
